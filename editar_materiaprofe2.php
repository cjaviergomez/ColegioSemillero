 ...
 //  error_reporting(E_ALL);
  ...
  //ini_set('display_errors', '1');
    ...
    $consul2="SELECT EXTRACT(YEAR FROM current_date) FROM current_date";
     ...
     $sql7="delete from profesormateria where id_grado='$i' and id_year='$year' and id_profesor='$profe'";
    ...
    foreach ($_POST["cod"]  as $mates) {
       ...
       $grado = pg_escape_string($conn, $_POST["cod"][$mates]);

       $sql2="select * from profesormateria where id_profesor='$profe' and id_materia='$materia' and id_year='$year' and id_grado='$grado' "; 
      ...
      if($filas==0){
        ...
        $sql="insert into profesormateria ( id_profesor, id_materia, id_year, id_grado ) values ( '$profe', '$materia', '$year', '$grado' )"; 
...
<header class="cabecera">
 ...
 echo " <hgroup class='titulos-wrap'>
    <h3 class='titulo wow bounceIn' data-wow-delay='0.3s'>Materias dictadas por el profesor ingresadas correctamente</h3>
    <h3 class='subtitulo wow bounceIn' data-wow-delay='0.5s'>Ahora puedes ingresar otras materias dictadas por profesores.</h3>
    </hgroup>";
          }
  ...
  echo "<hgroup class='titulos-wrap'>
    ...
    <h3 class='subtitulo wow fadeIn' data-wow-delay='0.6s' align='justify'>No se pudo ingresar las materias dictadas por el profesor correctamente, es probable que ya se halla ingresado previamente, por favor revisa bien y vuelve a intentarlo.</h3>
    </hgroup>";
