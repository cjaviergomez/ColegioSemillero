...
$mail-> Username='jcjcaballerog@gmail.com';
$mail-> Password='nirvana89';
...
foreach ($_POST["cod"]  as $correos) { //este ciclo agrega los correos selecionados

$mail-> addAddress($correos); //destinatarios es como un arreglo que se le agregan destinos

}

$mail-> From='jcjcaballerog@gmail.com'; //remitente
$mail-> FromName= $de;

$mail-> Subject=$asunto;
$mail-> Body= $mensaje;
$mail-> CharSet = 'UTF-8'; //justo antes de enviarlo se codifica en utf8 para que tome los acentos y ñ
    ...
    <div  style=" background:#F2F2F2 url('img/bg3.png') " >
     ...
     <?php
       ...
       echo "<hgroup class='titulos-wrap'>
             ...
             <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>No se pudo enviar el correo</h4>   
              <h4 class='subtitulo wow fadeIn' data-wow-delay='0.2s'>Colegio semillero dos mil</h4>   
      ...
      <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>Correo enviado exitosamente</h4>   
      <h4 class='subtitulo wow fadeIn' data-wow-delay='0.2s'>Colegio semillero dos mil</h4>   
