        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <form name="mi_formulario"  method="post" action="editar_secre_profe2.php" >

                    <h4><p>ID del Profesor: &nbsp;&nbsp;&nbsp; <input type="number" name= "cedula" maxlength=20 size="20" required/> </p></h4> <br>
