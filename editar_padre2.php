...
if ($_SESSION["nombre"]==""){
 ...
 //echo "cedula--->",$id;
  ...
  $sqlpadre="select* from padre where id_padre='$id'";

  

  $result = pg_query($conn,$sqlpadre);
  $test1=pg_num_rows($result);

   if ($test1 == 0){

 header("Location: nopadre.php");
...
?>
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Información del Padre</h2>
  ...
  <form role="form" class="form-horizontal" method="post" action="editar_padre3.php">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Estas a punto de actualizar la información del padre, revisa que todos los datos sean correctos, si estás seguro(a) dale clic en confirmar.
      </div>
