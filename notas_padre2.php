...
ini_set('display_errors', '1');
 ...
 $sql5="select id_periodo, (select nombre_mate from materia where materia.id_materia=notasperiodo.id_materia) as materia, valor from notasperiodo where id_materia='$materia' and id_estudiante='$id' and id_year='$year'"; 
        ...
        $(document).ready(function(){
                $("#grado").change(function () {
                    ...
                    $("#grado option:selected").each(function () {
                        ...
                        $.post("getmatepadre.php", { id_estudiante: id_estudiante }, function(data){
                            $("#materia").html(data);
                        });            
                    });
                })
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
                    <div class="navigation">
                        <div id="navigation">
                            <ul>
                                <li ><a href="father1.php" title="Home">Inicio</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                         <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >notas de <?php echo $nom; ?></h2>
                        <h4 class="subtitulo wow fadeIn" data-wow-delay="0.1s" >Alumno: <?php echo $nombre," ",$apellido; ?></h4>
          ...
          while ($row1=pg_fetch_array($actualizar)) 
              ...
              echo "
                ...
                <hgroup class='titulos-wrap'>
                            <h3 class='subtitulo wow bounceIn' data-wow-delay='0.3s'>No tiene notas por el momento</h3>
