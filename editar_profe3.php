  ...
  //no hago nada solo continuo en la pagina
   ...
   ini_set('display_errors', '1');
    ...
    $usuario = $_POST["usuario"];
       ...
       $sql1=" update profesor set id_profesor = '$id', nombre='$nombres', apellido= '$apellidos', telefono1= '$tel', celular1='$cel', direccion= '$dire', correo= '$correo' , id_usuario= '$usuario', barrio='$barrio', id_year= '$year' where id_profesor= '$id'";
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Actualizar información del Empleado</h2>
                  ...
                  <?php 
                    ...
                    if($result1==true){
                      ...
                      <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>Empleado  actualizada exitosamente</h4> 
                      <h4 class='subtitulo wow fadeIn' data-wow-delay='0.2s'>la información del empleado  ya ha sido actualizada.</h4>  
