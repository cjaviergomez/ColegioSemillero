            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registro Materia-Grado</h2>
...
<option value=""></option>
 <option value="carga1.php">Ingresar materias vistas en cada grado</option>
 <option value="consulta_materia_grado.php">Consultar la materias vistas en cada grado</option>
 <option value="editar_carga1.php">Editar materias vistas en un grado</option>
