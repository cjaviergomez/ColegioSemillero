...
// primero comprovar si ya se registraron esas notas
      $sql89=" select* from parciales where id_periodo='$periodo' and id_grado='$grado' and id_materia='$materia' and id_year='$year'"; 
        $result89= pg_query($conn,$sql89);
      $filas89=pg_num_rows($result89); //me dice la cantidad de resultados en este caso 5

      if ($filas89 > 0){

         header("Location: notas_ingresadas.php");
      ...
      //no hago nada solo continuo en la pagina
        ...
        $test1=pg_num_rows($resultnew);
         ...
         header("Location: cero_matriculados.php");
...
<link rel="stylesheet" href="css/tabla.css">
    ...
    <div  style=" background:#F2F2F2 url('img/bg3.png') " >
      ...
      <form  METHOD=POST  action="parciales3.php">
      ...
      <TH> <center> Nombre de Nota </center> </TH> 
...
<?PHP        
   ...
   //aqui se crea las filas de la tabla
  ...
  echo "
        <tr>  
           ...
           <td> <center> $i </center> </td>
              <input type='hidden' name= 'num[".$i."]' value='$i' size='17' required />

              <input type='hidden' name= 'periodo' value='$periodo' size='17' required />
              <input type='hidden' name= 'grado' value='$grado' size='17' required />
              <input type='hidden' name= 'materia' value='$materia' size='17' required />
              <input type='hidden' name= 'year' value='$year' size='17' required />
              <input type='hidden' name= 'numero' value='$numero' size='17' required />

           <td><center> <input type='text' name= 'nombres[".$i."]' value='' required /> </center> </td>

           <td> <center>  <input type='number' min='1' step='1' max='100' name= 'porcentaje[".$i."]' value=''  required /></center> </td>
...
<input type="submit"  name="actualizar" value="Registrar" class="btn btn-primary">&nbsp;&nbsp;&nbsp;

<a href="ingresa_parciales.php" class="btn btn-primary">Atras</a>
