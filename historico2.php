...
if ($_SESSION["nombre"]==""){
 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
    ...
    $sql27="select nombre, apellido from estudiante where id_estudiante='$id'";
    $result27 = pg_query($conn,$sql27);

    $row27 = pg_fetch_array($result27);
    $estudian = $row27["nombre"];
    $apellido = $row27["apellido"];
...
<?PHP
    ...
    $sql4="select id_materia, id_estudiante, (select nombre_mate from materia where materia.id_materia=notasfinales.id_materia), (select nombre from estudiante where estudiante.id_estudiante=notasfinales.id_estudiante), valor from notasfinales where id_estudiante='$id' and id_grado='$grado' and id_year='$year' order by id_estudiante ";
...
<p>.</p>
             ...
             <h3 class='subtitulo wow fadeIn' data-wow-delay='0.1s'>No hay notas finales en ese año.</h3>
...
<a href="historico1.php" class="btn btn-primary">Atras</a>
