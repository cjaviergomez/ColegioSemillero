...
<header class="cabecera">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >consultar materias dictadas por un profesor</h2>
 ...
 <font color="" size="4">Selecciona el profesor:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <br>


 <form action="consulta_profesor_materia2.php"  method="post" >
...
$idprofe= $row["id_profesor"] ; 
$codigo3 = $row["nombre"] ; 
$ape= $row["apellido"] ;//Asignamos el id del campo que quieras mostrar
echo "<option value=".$idprofe.">".$codigo3." ".$ape."</option>"; 
//Llenamos el option con su value que sera lo que se lleve al archivo registrar.php y que sera el id de tu campo y luego concatenamos el nombre que se mostrara en el combo ".$codigo3." ".$ape."
} //Cerramos el ciclo 
?>
</select>
<br>

 <font color="" size="4">Selecciona el año:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <br>
