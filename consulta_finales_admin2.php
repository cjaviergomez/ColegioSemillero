...
<?PHP
    ...
    $sql4="select id_estudiante, (select nombre from estudiante where estudiante.id_estudiante=notasfinales.id_estudiante ) as nombre ,(select nombre_mate from materia where id_materia='$materia') as materia, id_year , (select apellido from estudiante where estudiante.id_estudiante=notasfinales.id_estudiante ), valor from notasfinales where id_materia='$materia' and id_year='$year' and id_grado='$grado' order by id_estudiante";
          ...
          while ($row1=pg_fetch_array($result4)) 
              { 
                    ...
                    echo "<tr>
                           ...
                           <input type='hidden' name='per[".$codigo1."]' value='".$ye."' size='5'/>  
...
<p>.</p>
 ...
 ";
             ...
             <h3 class='subtitulo wow fadeIn' data-wow-delay='0.1s'>Todavía no hay notas finales en esta materia, puedes revisar más tarde.</h3>
...
<a href="consulta_finales_admin1.php" class="btn btn-primary">Atras</a>
                    </div>
                    <!-- /.section title start-->
