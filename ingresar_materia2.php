...
if ($_SESSION["nombre"]==""){
 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
     ...
     $sql="insert into materia ( nombre_mate) values ( '$materia')"; 
...
<header class="cabecera">
 ...
 echo " <hgroup class='titulos-wrap'>
    <h3 class='titulo wow bounceIn' data-wow-delay='0.3s'>Materia ingresada correctamente</h3><br>";
          }
  ...
  echo "<hgroup class='titulos-wrap'>
    <h3 class='subtitulo wow fadeIn' data-wow-delay='0.6s' align='justify'>No se pudo ingresar la materia correctamente, es probable que ya se halla ingresado previamente, por favor revisa bien y vuelve a intentarlo.</h3>
    </hgroup>";
...
?>
          ...
          <a href="ingresar_materia.php"><button class="btn btn-primary">Regresar</button></a> 
                    </div>
                    <!-- /.section title start-->
