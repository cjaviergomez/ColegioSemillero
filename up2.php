...
<header class="cabecera">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Subida de Material</h2>
    ...
    if ($nombre != "") {
        if (copy($ruta, $destino)) {
            ...
            $sql1="insert into archivos (id_grado , titulo ,tamano ,nombre,id_materia,id_year,tipo, id_profesor) values ('$grado','$titulo','$tamanio','$nombre', '$materia', '$year', '$tipo', '$idp')";
            $result = pg_query($conn, $sql1);

            if($result){
                echo "
                      <hgroup class='titulos-wrap'>
                      <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>Archivo subido exitosamente</h4>   
                      <h4 class='subtitulo wow fadeIn' data-wow-delay='0.2s'>Ahora puedes subir más archivos si lo deseas.</h4>   
                      </hgroup>
            ...
            echo "
                      ...
                      <hgroup class='titulos-wrap'>
                      <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>No se pudo subir el archivo</h4>   
