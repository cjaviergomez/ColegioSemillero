  ...
  //no hago nada solo continuo en la pagina
     ...
     $idprofe = $_SESSION["identi"]; //viene por sesión
  
     $sql1="select id_estudiante, nombre, apellido, id_grado, correo from estudiante where id_grado='$grado' and id_year= '$year'";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      ...
                      <form  METHOD=POST action="profe_recomendacion3.php" >
...
<?PHP          
          ...
          while ($row1=pg_fetch_array($result)) //este while es para crear las columnas de la tabla aqui estan las notas
              { 
                    ...
                    echo " <tr>
                    <td> <center><input type='checkbox' name= 'cod[".$col1."]' value='".$col1."'/> </center></td>
...
<font color="" size="3" >Recomendación: </font><br><textarea name="mensaje_txa" rows="5" cols="65" required/></textarea><br>
