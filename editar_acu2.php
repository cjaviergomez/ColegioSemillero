...
<header class="cabecera">
    ...
    <div  style=" background:#F2F2F2 url('img/bg3.png') " >
     ...
     <form role="form" class="form-horizontal" method="post" action="editar_acu3.php">

      <div class="form-group">
      <div class="col-sm-3"><label>Identificación</label><input type="number" name="id" value='<?php echo $id;?>' class="form-control" placeholder="" required/></div>
      ...
      <div class="col-sm-3"><label>Parentesco</label><input type="text" name="parentesco" value='<?php echo $parentesco;?>' class="form-control" placeholder="" required/></div>
      <div class="col-sm-3"><label>Telefono</label><input type="number" name="telefono" value='<?php echo $tel1;?>' class="form-control" placeholder="" required/></div>
    </div>
