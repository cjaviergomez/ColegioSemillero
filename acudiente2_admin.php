...
// llamar la funciones 
 ...
 // error_reporting(E_ALL);
  ...
  //ini_set('display_errors', '1');
    ...
    $sql1=" insert into acudiente (id_acudiente, nombre, telefono1, parentesco) values ('$id','$nombre', '$tel', '$parentesco')";
   ...
   <?php
        ...
        if($result1==true){
            ...
            echo "
                ...
                <h4 class='titulo  wow fadeIn' data-wow-delay='0.4s'>Acudiente registrado exitosamente</h4></br>    
            ...
            //header("Location: matricula1.php");
                 ...
                 <h5 class='titulo wow fadeIn' data-wow-delay='0.4s'>El Acudiente no se pudo registrar</h5></br> 
                     <h4 class='subtitulo wow fadeIn' data-wow-delay='0.4s' align='justify'>Es posible que el acudiente ya este registrado, o hallas recargado la página una vez registrado el acudiente, o tal vez ocurrió un error durante el llenado del formulario, inténtalo de nuevo.</h4>
