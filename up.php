            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Subir material a tus alumnos</h2>
     ...
     <figure  class="post wow fadeInUp" data-wow-delay="0.7s">
                        <img  class="img-circle"  src= <?php echo $_SESSION["foto"];?>   height="150" width="150"> 
                         ...
                         <br>
                                      ...
                                      <form method="post" action="up2.php" enctype="multipart/form-data">


               <h5 align="left">Titulo:</h5> <input class="form-control" type="text" name="titulo" size="" required/> 
               
                <h5 align="left" >Selecciona el Grado:</h5>
                   ...
                   <h5 align="left">Selecciona la Materia:</h5>
