    ...
    $(document).ready(function(){
        $("#grado").change(function () {
          ...
          $("#grado option:selected").each(function () {
            id_grado = $(this).val();
            $.post("getmateprofe.php", { id_grado: id_grado }, function(data){
              $("#materia").html(data);
            });            
          });
        })
...
<form action="Parciales2.php" METHOD=POST >
...
<div><font color="" size="4">Selecciona la Materia:</font>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div>
 <font color="" size="4">Cantidad de Notas:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
