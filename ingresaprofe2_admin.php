 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
   ...
   //ini_set('display_errors', '1');
    ...
    $clave = $_POST["id"]; //encriptado mediante el algoritmo sha1




  
    $sql1=" insert into profesor (id_profesor, nombre, apellido, telefono1, celular1, direccion, correo, id_usuario, clave, barrio, id_year, id_imagen) values ('$id', '$nombres','$apellidos', '$tel', '$cel', '$dire', '$correo','$usuario','$clave', '$barrio', '$year','img/avatar.png')";
...
<header class="cabecera">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registro Empleado</h2>
   ...
   if($result1==true){
           ...
           echo "
                  ...
                  <h4 class='titulo wow bounceIn' data-wow-delay='0.1s'>Empleado registrado exitosamente</h4></br>
                    <h4 class='subtitulo wow fadeIn' data-wow-delay='0.1s' align='justify'>El Empleado ya se encuentra habilitado en el sistema, su usuario y contraseña serán su número de identificación, el podrá modificar esto cuando inicie sesión, gracias por utilizar el sistema académico del colegio semillero dos mil.</h4>
                   </hgroup>
           ...
           ";
                ...
                echo "
                  ...
                  <hgroup class='titulos-wrap'>
                  <h4 class='titulo wow bounceIn' data-wow-delay='0.1s'>No se pudo registar el Empleado</h4></br>
                    <h4 class='subtitulo wow fadeIn' data-wow-delay='0.1s' align='justify'>Es posible que ya este registrado en el sistema, o haya ocurrido un error durante el proceso, vuelve a intentarlo.</h4>
                   </hgroup>
