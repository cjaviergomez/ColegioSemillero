  ...
  //no hago nada solo continuo en la pagina
    ...
    $materia2 = $row["nombre_mate"];
            ...
            $cali = pg_escape_string($conn, $_POST["cali"][$codes]); //nota materia
              ...
              $sql5=" update notasperiodo set valor='$cali' where id_estudiante='$id' and id_materia='$materia' and id_periodo='$periodo' and id_grado='$grado' and id_year='$year' "; 
              ...
              //codigo que genera la nota final******************
                  ...
                  while ($row1=pg_fetch_array($resultnew)) 
                      ...
                      if($resultnew2==true){
                         ...
                         header("Location: notas_finales_admin.php");
        ...
        if( $actualizar==True){ 
              ...
              echo "  
                   ...
                   <hgroup class='titulos-wrap'>
                    <h3 class='subtitulo wow fadeIn' data-wow-delay='0.1s'>Las notas fueron modificadas exitosamente</h3>
