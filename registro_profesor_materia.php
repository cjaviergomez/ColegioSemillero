            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        ...
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registro Materia-Profesor</h2>
...
<div>
 <font color="" size="4">Seleccione la opción que desees:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <br>
 <br>
<select class="form-control" name="forma" onchange="location = this.value;">
<option value=""></option>
 <option value="materiaprofe1.php">Ingresar materias dictadas por un profesor</option>
 <option value="consulta_profesor_materia.php">consultar materias dictadas por un profesor</option>
 <option value="editar_materiaprofe1.php">Editar materias dictadas por un profesor</option>
