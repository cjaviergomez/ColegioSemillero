...
<header class="cabecera">
    ...
    <div  style=" background:#F2F2F2 url('img/bg3.png') " >
     ...
     <h4 class="titulo wow fadeIn" data-wow-delay="0.2s">las mejoras ya han sido ingresadas</h4>   
      <h4 class="subtitulo wow fadeIn" data-wow-delay="0.2s">asi como las notas finales ya han sido generadas</h4>   
      <h4 class="subtitulo wow fadeIn" data-wow-delay="0.2s">Docente <?php echo $_SESSION["nombre"]; echo" "; echo $_SESSION["apellido"];?> si necesitas modificar alguna nota consulta con el administrador.</h4>
