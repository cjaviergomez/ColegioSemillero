...
if ($_SESSION["nombre"]==""){
 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
    ...
    $sql2="select id_grado, id_year, (select nombre_mate from materia where materia.id_materia = gradomateria.id_materia) from gradomateria where id_grado='$grado' and id_year='$year'";
    ...
    <TR>
     ...
     <TH><center>Materia</center> </TH> 
          ...
          while ($row1=pg_fetch_array($result2)) 
             ...
             <h3 class='subtitulo wow fadeIn' data-wow-delay='0.1s'>No hay materias registradas por el momento.</h3>
...
<p>.</p>
<a href="consulta_materia_grado.php"><button class="btn btn-primary">Regresar</button></a>  
