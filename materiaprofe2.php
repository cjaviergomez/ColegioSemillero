...
<header class="cabecera">
 ...
 echo " <hgroup class='titulos-wrap'>
  ...
  echo "<hgroup class='titulos-wrap'>
    ...
    <h3 class='subtitulo wow fadeIn' data-wow-delay='0.5s' align='justify'>No se pudo ingresar las materias dictadas por el profesor correctamente, es probable que ya se halla ingresado previamente, por favor revisa bien y vuelve a intentarlo.</h3>
    </hgroup>";
