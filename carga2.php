...
<header class="cabecera">
 ...
 echo " <hgroup class='titulos-wrap'>
    <h3 class='titulo wow bounceIn' data-wow-delay='0.3s'>Carga académica Ingresada correctamente</h3><br>
    <h3 class='subtitulo wow bounceIn' data-wow-delay='0.5s'>Ahora puedes ingresar la carga académica de otro grado.</h3>
    </hgroup>

     <a href='carga1.php'><button class='btn btn-primary'>Regresar</button></a>  ";
          }
