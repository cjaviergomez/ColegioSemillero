...
?>
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registrar empleado</h2>
  ...
  <form role="form" class="form-horizontal" method="post" action="ingresaprofe2_admin.php">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3"><label>Dirección Residencia</label><input type="text" name="direccion" class="form-control" placeholder="" required/></div>
      <div class="col-sm-3"><label>Barrio</label><input type="text" name="barrio" class="form-control" placeholder="" required/></div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4"><label>Celular</label><input type="text" name="celular" class="form-control" placeholder="" required/></div>
      <div class="col-sm-4"><label>Email</label><input type="text" name="correo" class="form-control" placeholder="ejemplo@hotmail.com" required/></div>
