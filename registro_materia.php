...
<option value=""></option>
 <option value="ingresar_materia.php">Ingresar materias nuevas</option>
 <option value="editar_materia.php">Editar el nombre de una materia</option>
 <option value="consultar_materias.php">Consultar las materias vistas en el colegio</option>
