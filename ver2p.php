...
ini_set('display_errors', '1');
 ...
 $sql5="select id_archivo, (select nombre_mate from materia where materia.id_materia=archivos.id_materia), nombre, titulo, id_profesor, (select nombre from profesor where profesor.id_profesor= archivos.id_profesor), (select apellido from profesor where profesor.id_profesor= archivos.id_profesor) from archivos where id_grado='$grado'and id_materia='$materia' and id_year='$year'"; 
 $actualizar= pg_query($conn,$sql5);

  
  $sql ="select nombre_mate from materia where id_materia='$materia'"; 
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Material de estudio subido de <?php echo $nom;  ?></h2>
      ...
      <?PHP    
                ...
                if($fias>0){
                  ...
                  echo "
                            ...
                            <TR> 
                            <TH>&nbsp;&nbsp;Nombre</TH>
                            <TH>&nbsp;&nbsp;Archivos (clic para descargar)</TH>
                            <TH>&nbsp;&nbsp;Autor</TH>
                            </TR> 
                            </thead> ";
          ...
          while ($row1=pg_fetch_array($actualizar)) 
              { 
                      ...
                      echo "</td>";
                      echo "<td>";
                      echo "<b><a href='bajar3.php?id=$codigo1'>";
                      echo $codigo2;
                      echo "</a></b>";
                      echo "</td>";
                      echo "<td>";    
                      echo $profename," ", $apellido;                     
                      echo "</td>";
                      echo "</tr>";
                      //echo "</tbody>";
              }  
              ...
              echo "
                ...
                <hgroup class='titulos-wrap'>
                            <h3 class='subtitulo wow bounceIn' data-wow-delay='0.3s'>No hay archivos subidos en esta materia</h3>
...
<a href="ver1p.php"><button type="button" class="btn btn-primary">¡Regresar!</button></a>
