...
$sql1=" select * from profesor where id_profesor='$usuario' and clave ='$clave' ";
...
if($check > 0){
              ...
              $sql5=" update profesor set clave='$newclave' where id_profesor='$usuario'"; 
      ...
      <?PHP    
        ...
        if( $actualizar==True){ 
              ...
              echo "  
                 ...
                 <center> <a href='clave_secre.php'><input class='btn btn-primary'  value='Intetarlo de nuevo'> </a>  </center>
