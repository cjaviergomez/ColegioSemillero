...
if ($_SESSION["nombre"]==""){
 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
    ...
    $sql1=" update madre set nombres = '$nombres', apellidos = '$apellidos', nacimiento='$born', id_madre='$id', direccion_casa='$dire', celular='$cel', correo='$correo', estrato='$estrato', nivel_academico='$nivel', profesion='$profesion', empresa= '$empresa', cargo='$cargo', direccion_laboral='$dirtrabajo', telefono_laboral='$teltrabajo', telefono_casa='$tel', barrio='$barrio', id_usuario='2' where id_madre= '$id' ";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                  ...
                  <?php 
                    ...
                    if($result1==true){
                      ...
                      <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>Madre actualizada exitosamente</h4> 
                      <h4 class='subtitulo wow fadeIn' data-wow-delay='0.2s'>la información de la madre ya a sido actualizada.</h4>  
                ...
                ";  
                      ...
                      <hgroup class='titulos-wrap'>
                      <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>No se pudo actualizada la informacion</h4>   
