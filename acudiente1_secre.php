...
<header class="cabecera">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registrar Acudiente</h2>
  ...
  <form role="form" class="form-horizontal" method="post" action="acudiente2_secre.php">

      <div class="form-group">
      <div class="col-sm-3"><label>Identificación</label><input type="number" name="id" class="form-control" placeholder="" required/></div>
      <div class="col-sm-3"><label>Nombre</label><input type="text" name="nombre" class="form-control" placeholder="" required/></div>
      <div class="col-sm-3"><label>Parentesco</label><input type="text" name="parentesco" class="form-control" placeholder="" required/></div>
      <div class="col-sm-3"><label>Telefono</label><input type="number" name="telefono" class="form-control" placeholder="" required/></div>
    </div>
