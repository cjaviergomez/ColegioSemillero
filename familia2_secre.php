 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
   ...
   //ini_set('display_errors', '1');
    ...
    $sql1=" insert into padre (nombres, apellidos, nacimiento, id_padre, direccion_casa, celular, correo, estrato, nivel_academico, profesion, empresa, cargo, direccion_laboral, telefono_laboral, telefono_casa, barrio, id_usuario, id_imagen ) values ('$nombres', '$apellidos', '$born', '$id', '$dire', '$cel', '$correo', '$estrato' ,'$nivel', '$profesion', '$empresa', '$cargo', '$dirtrabajo', '$teltrabajo', '$tel', '$barrio', '2', 'img/avatar.png')";
    ...
    <div  style=" background:#F2F2F2 url('img/bg3.png') " >
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registrar Padre</h2>
        ...
        if($result1==true){
            ...
            echo "
                ...
                <h4 class='titulo  wow fadeIn' data-wow-delay='0.4s'>Padre registrado exitosamente</h4></br>    
                <h4 class='subtitulo  wow fadeIn' data-wow-delay='0.4s'align='justify'>El padre ya se encuentra habilitado en el sistema, su usuario y contraseña serán su número de identificación, el podrá modificar esto cuando inicie sesión, gracias por utilizar el sistema académico del colegio semillero dos mil. Ahora puedes continuar registrando la información familiar.</h4> 
            ...
            //header("Location: matricula1.php");
                 ...
                 <h5 class='titulo wow fadeIn' data-wow-delay='0.4s'>El padre no se pudo registrar</h5></br> 
                <h4 class='subtitulo wow fadeIn' data-wow-delay='0.4s' align='justify'>Es posible que el padre ya este registrado, o hallas recargado la página una vez registrado el padre, o tal vez ocurrió un error durante el llenado del formulario, inténtalo de nuevo.</h4>     
