...
if ($_SESSION["nombre"]==""){
 ...
 $conn=conectarse(); 
  ...
  $sqlacu="select* from acudiente where id_acudiente='$id'";

  

  $result = pg_query($conn,$sqlacu);
  $test1=pg_num_rows($result);


if ($test1 == 0){

 header("Location: noacu_secre.php");
...
<header class="cabecera">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Actualizar información del Acudiente</h2>
    ...
    <form role="form" class="form-horizontal" method="post" action="editar_secre_acu3.php">

      <div class="form-group">
      <div class="col-sm-2"><label>Identificación</label><input type="number" name="id" value='<?php echo $id;?>' class="form-control" placeholder="" required/></div>
      <div class="col-sm-3"><label>Nombre</label><input type="text" name="nombre" value='<?php echo $nombre;?>' class="form-control" placeholder="" required/></div>
      <div class="col-sm-2"><label>Parentesco</label><input type="text" name="parentesco" value='<?php echo $parentesco;?>' class="form-control" placeholder="" required/></div>
      <div class="col-sm-2"><label>Telefono</label><input type="number" name="telefono" value='<?php echo $tel1;?>' class="form-control" placeholder="" required/></div>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Estas a punto de actualizar la información de acudiente, revisa que todos los datos sean correctos, si estás seguro(a) dale clic en 
        confirmar.
      </div>
