            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                    ...
                    if($result1==true){
                      ...
                      <h4 class='titulo wow fadeIn' data-wow-delay='0.2s'>Profesor actualizado exitosamente</h4> 
                      <h4 class='subtitulo wow fadeIn' data-wow-delay='0.2s'>la información del Profesor ya ha sido actualizada.</h4>  
