...
<header class="cabecera">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="profe1.php"><img width="100" height="60" src="img/logo3.png"></a>
                </div>
   ...
   <section class="contac">
     ...
     <h4 class="titulo wow fadeIn" data-wow-delay="0.2s">no hay alumnos matriculados en esta materia</h4>   
      <h4 class="titulo wow fadeIn" data-wow-delay="0.2s"></h4>   
      <h4 class="subtitulo wow fadeIn" data-wow-delay="0.2s">Docente <?php echo $_SESSION["nombre"]; echo" "; echo $_SESSION["apellido"];?> si necesitas ayuda, consulta con el administrador.</h4>
