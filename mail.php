    ...
    <div  style=" background:#F2F2F2 url('img/bg3.png') " >
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        ...
                        <h5 class="small-title">Estudio Amor y Paz.</h5>
                         ...
                         <figure  class="post2 wow fadeIn" data-wow-delay="0.2s">
                        <img  class="img-circle"   src= <?php echo $_SESSION["foto"];?> height="190" width="190"> 
                         </figure>
             ...
             if($mail->send() == false){
             echo "        
                            <h4 class='subtitulo wow fadeInUp' data-wow-delay='0.3s'>No se pudo enviar el correo </h4>
                            <h4 class='subtitulo wow fadeInUp' data-wow-delay='0.3s'>Intentalo nuevamente</h4>
                             ";
            // echo $mail-> ErrorInfo;
               ...
               echo "       
                            <h3 class='titulo wow fadeInUp' data-wow-delay='0.4s'>Correo Enviado</h3>
                            <h3 class='subtitulo wow fadeInUp' data-wow-delay='0.5s'>Exitosamente</h3>
                             ";
            }
