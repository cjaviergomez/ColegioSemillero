...
$sql1=" select * from madre where id_madre='$usuario' and clave ='$clave' ";
...
if($check > 0){
              ...
              $sql5=" update madre set clave='$newclave' where id_madre='$usuario'"; 
    ...
    <div  style=" background:#F2F2F2 url('img/bg3.png') " >
        ...
        if( $actualizar==True){ 
              ...
              echo "  
                  ...
                  <center> <a href='clave_madre.php'><input class='btn btn-primary'  value='Intetarlo de nuevo'> </a>  </center>
