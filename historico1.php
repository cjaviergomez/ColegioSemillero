            ...
            id_year  = $(this).val();
                 ...
                 $("#grado").change(function () {
                           ...
                           id_grado = $(this).val();
                            ...
                            $.post("getestu.php", { id_grado: id_grado, id_year: id_year }, function(data){
                          $("#materia").html(data);
            });  
...
<div><font color="" size="4">Selecciona el Año:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$codigo2 = $row["id_year"] ; //Asignamos el id del campo que quieras mostrar
...
<div><font color="" size="4">Selecciona el Estudiante:</font>&nbsp;&nbsp;&nbsp;&nbsp;
