 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
   ...
   //ini_set('display_errors', '1');
    ...
    $sql1=" insert into profesor (id_profesor, nombre, apellido, telefono1, celular1, direccion, correo, id_usuario, clave, barrio, id_year, id_imagen) values ('$id', '$nombres','$apellidos', '$tel', '$cel', '$dire', '$correo','$usuario','$id', '$barrio', '$year','img/avatar.png')";
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registrar Profesor</h2>
