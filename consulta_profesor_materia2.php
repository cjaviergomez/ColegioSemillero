...
if ($_SESSION["nombre"]==""){
 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
    ...
    $sql2="select id_profesor, id_grado, id_materia, (select nombre from profesor where profesor.id_profesor=profesormateria.id_profesor), (select nombre_mate from materia where materia.id_materia=profesormateria.id_materia), (select apellido from profesor where profesor.id_profesor=profesormateria.id_profesor) from profesormateria where id_profesor='$profe' and id_year='$year'";
    ...
    <TH><center>Grado</center></TH>
        ...
        ";
          ...
          while ($row1=pg_fetch_array($result2)) 
             ...
             <h3 class='subtitulo wow fadeIn' data-wow-delay='0.1s'>No hay materias dictadas por el profesor en ese año.</h3>
...
<p >.</p>
<a href="consulta_profesor_materia.php"><button class="btn btn-primary">Regresar</button></a>  
