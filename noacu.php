    ...
    <div class="header">
                        ...
                        <div id="navigation">
                            <ul>
                               ...
                               <li class="has-sub"> <a href="" title="">Alumno</a>
                                 ...
                                 <li><a href="editar_acu1.php">Actualiza Acudiente</a></li>
                            ...
                            <li class="has-sub"> <a href="" title="">Registro Académico</a>
                                 ...
                                 <li><a href="asistencia.php">Asistencia y convivencia</a></li>
                                  ...
                                  <li><a href="ingresaprofe1_admin.php">Empleado</a></li>
        ...
        <button  style="border: #FFF 1px solid; background-color: #FFF">
         ...
         <ul >
           ...
           <li><a href="confi_padre.php">Configuración</a></li>
                      ...
                      <div class="section-title mb60 text-center">
                        ...
                        <h5 class="small-title">Estudio Amor y Paz.</h5>
                              ...
                              <hgroup class="titulos-wrap">
                                 <h4 class="titulo wow fadeIn" data-wow-delay="0.2s">El acudiente no existe</h4>   
                             <h4 class="subtitulo wow fadeIn" data-wow-delay="0.2s">Revisa la identificación del acudiente, parece ser que no hay un acudiente registrado con esta identificación.</h4>   
