  ...
  //no hago nada solo continuo en la pagina
   ...
   $conn=conectarse(); 
    ...
    $result4 = pg_query($conn,$sql4);
               ...
               $_SESSION["identi"];  //id del usuario
               $_SESSION["nombre"];
               $_SESSION["apellido"];
               $_SESSION["foto"];
              ...
              $sql1=" select id_materia ,( select nombre_mate from materia where materia.id_materia=gradomateria.id_materia) as name from gradomateria where id_grado='$grado' and id_year='$year'";
              $result = pg_query($conn,$sql1);

            //  $ciclo=pg_num_rows($result);
             // echo "filas-->",$ciclo;
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Ver material de estudio subido</h2>
                 ...
                 <form method="post" action="ver2p.php" enctype="multipart/form-data">

          
               <div>
                <font color="" size="4">Selecciona el Grado:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <div>
                   <font color="" size="4">Selecciona la Materia:</font>&nbsp;&nbsp;&nbsp;&nbsp;
                   <select  class="form-control" name="materia" id="materia" required/> 
 
<!--  <option value="0">Materia</option> Creamos el select con el atributo name "combo" que identificara el archivo registrar.php-->
                   </select>
                   </div> 
                     </br>
                        
                 <input  class="btn btn-primary" type="submit" value="Ver Archivos" name="subir">                    
