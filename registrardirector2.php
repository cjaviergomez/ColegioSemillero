...
if ($_SESSION["nombre"]==""){
 ...
 header("Location: index4.html");
  ...
  //no hago nada solo continuo en la pagina
     ...
     if($test > 0){
     $sql6 = "delete from directorgrado where id_profesor='$profesor' and id_grado='$grado' and id_year='$year'";
     $result6 = pg_query($conn, $sql6); //Elimina los anteriores registros.
     $sql7=" insert into directorgrado (id_profesor, id_grado, id_year) values ('$profesor', '$grado', '$year') ";  
     $resultado7= pg_query($conn,$sql7); //Agrega un nuevo registro.
     }else{
        $sql8=" insert into directorgrado (id_profesor, id_grado, id_year) values ('$profesor', '$grado', '$year') ";  
        $resultado8= pg_query($conn,$sql8); //Agrega un nuevo registro.
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registro Director-Grado</h2>
                        ...
                        <br>
                      <a href='registrardirector.php' class='btn btn-primary'>Atras</a>
