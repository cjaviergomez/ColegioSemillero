            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        ...
                        <img  class="img-circle"  src= <?php echo $foto;?>   height="150" width="150">  
                         </figure><br>

  <form role="form" class="form-horizontal" method="post" action="editar_profe3.php">
