            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        ...
                        <h5 class="small-title">Estudio Amor y Paz.</h5> <br><br>

                         
  <div class="row">
      <div class="col-sm-6"> 

                <h3 align="left" class="titulo wow fadeInDown" data-wow-delay="0.3s" ><a href="up_foto1padre.php">Nueva imagen de perfil</a></h3>
        ...
        <div  class="col-sm-6">
     <h3 align="left" class="titulo wow fadeInDown" data-wow-delay="0.3s" ><a href="clave_padre.php">Cambiar contraseña</a></h3>
           <p align="Justify">
