...
function validate(e) {    
  ...
  if(contador2 != 0){
     alert ('Verifica que cada estudiante tenga chequeada al menos una observacion academica');
      if (e.preventDefault) {
        e.preventDefault();
      } else {
      e.returnValue = false;
  ...
  if(contador2 != 0){
     alert ('Verifica que cada estudiante tenga chequeada al menos una observacion de convivencia');
      if (e.preventDefault) {
        e.preventDefault();
      } else {
      e.returnValue = false;
...
<?PHP  
    ...
    if( $test1 > 0){   
        ...
        echo " 
      <form action='dbasistencia.php' method='post' id='form' name='form' onsubmit='validate(event);'>
        ...
        <div class='container'>
            ...
            <div class='row'>
             ...
             <h3 class='subtitulo wow fadeIn' data-wow-delay='0.1s'>Todavía no hay estudiantes registados en el grado, puedes revisar más tarde.</h3>
              ...
              <br>
              <a href='asistencia.php' class='btn btn-primary'>Atras</a>
              </div>
              </div>
              </div>
              </div>
