...
// error_reporting(E_ALL);
  ...
  foreach ($_POST["cod"]  as $codes) { //esto se ejecuta el numero de estudientes veces
    ...
    $id = pg_escape_string($conn, $_POST["cod"][$codes]);
    $name = pg_escape_string($conn, $_POST["nombre"][$codes]);



     $sql="update materia set nombre_mate='$name' where id_materia= '$id' "; 
     $ingresar= pg_query($conn,$sql);
...
<link rel="stylesheet" href="css/tabla.css">
            ...
            <div class="row">
                ...
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                      <div class="section-title mb60 text-center">
                        <!-- section title start-->
                        <h2 class="titulo wow fadeInDown" data-wow-delay="0.1s" >Registro Académico</h2>
 ...
 echo " <hgroup class='titulos-wrap'>
    <h3 class='titulo wow bounceIn' data-wow-delay='0.3s'>¡Materia actualizada correctamente!</h3><br>
    </hgroup>";
          }
  ...
  echo "<hgroup class='titulos-wrap'>
    <h3 class='subtitulo wow fadeIn' data-wow-delay='0.6s' align='justify'>No se pudo actualizar las materias correctamente, es probable que ya se halla ingresado previamente, por favor revisa bien y vuelve a intentarlo.</h3>
    </hgroup>";
